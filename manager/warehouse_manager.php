                ...
                <div class="row cm-fix-height">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Pending Arrivals From Stock Officer</div>
                               ...
                               <table class="table table-hover" id="my_selected_table">
                                ...
                                <tbody id="add_customers_table" style="text-align: center">
                                   ...
                                   <?php  
                                    ...
                                    $get_stock_officer_details = mysqli_query($connection,"SELECT * FROM stock_oficer JOIN product_names ON `stock_oficer`.`stock_product_name` = `product_id` JOIN product_category ON `stock_oficer`.`stock_product_category` = `product_category`.`product_category_id` WHERE `record_status` = '0'");
                                    while ($stock_officer_detail = mysqli_fetch_array($get_stock_officer_details)) { ?>
                                        
                                        <tr>
                                           
                                            <td><?php echo $stock_officer_detail["product_name"]; ?></td>
                                            ...
                                            <td><button class="btn btn-primary btn_approve" id="<?php echo $stock_officer_detail["stock_officer_record_id"];    ?>">Approve</button></td>
                                        </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form_approve_stock_officer" data-toggle="validator">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" class="form-control" id="txt_quantity_received" required="required" placeholder="Quantity Received">
                                </div>
                                </div>
                                <div class="col-lg-6">
                                     <div class="form-group">
                                    <label for="name_holder" class="col-form-label">Production Date:</label>
                                    <input type="date" class="form-control" id="txt_production_date" required="required" placeholder="Production Date">
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" class="form-control" id="txt_expiry_date" required="required" placeholder="Expiry Date">
                                </div>
                                </div>
                                <div class="col-lg-6">
                                     <div class="form-group">
                                    <label for="name_holder" class="col-form-label">Receiver:</label>
                                    <input type="text" class="form-control" id="txt_receiver" required="required" placeholder="Receiver">
                                </div>
                                </div>
                            </div>
