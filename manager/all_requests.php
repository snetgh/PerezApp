                            ...
                            <table class="table" id="my_selected_table">
                                ...
                                <tbody>
                                   ...
                                   $my_branch_id = $_COOKIE['bi'];
                                    ...
                                    $get_request_query = mysqli_query($connection,"SELECT * FROM checked_branch_request_table JOIN system_branches ON checked_branch_request_table.receiving_branch = system_branches.system_branch_id WHERE `sending_branch` LIKE '%$get_my_branch_name%'");
