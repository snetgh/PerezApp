<div id="global">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
                        <div class="panel panel-default">
                            <div class="panel-heading">Add Cash Customer</div>
                            <div class="panel-body">
                                <form class="form-horizontal" data-toggle="validator" id="form_add_cash_customer" method="post">
                ...
                <div class="row cm-fix-height">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">List Of Cash Customers</div>
                            <div class="panel-body">
                               <table class="table table-hover" id="my_selected_table">
                                ...
                                <tbody id="add_customers_table">
                                   ...
                                   <?php  
                                    ...
                                    $get_users_query = mysqli_query($connection,"SELECT * from customers_table join system_branches on `customers_table`.`customer_branch` = `system_branches`.`system_branch_id` ORDER BY `customers_table`.`customers_id` DESC");
                                    while ($get_each_user = mysqli_fetch_array($get_users_query)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date("d-M-Y",strtotime($get_each_user["customer_timestamp"])) ?></td>
                                        </tr>
