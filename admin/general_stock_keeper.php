                               ...
                               <table class="table table-hover" id="my_selected_table">
                                ...
                                <tbody id="add_customers_table" style="text-align: center">
                                   ...
                                   <?php  
                                    ...
                                    $get_stock_officer_details = mysqli_query($connection,"SELECT * FROM stock_oficer JOIN product_names ON `stock_oficer`.`stock_product_name` = `product_id` JOIN product_category ON `stock_oficer`.`stock_product_category` = `product_category`.`product_category_id` JOIN warehouse_manager on `stock_oficer`.`stock_officer_record_id` = `warehouse_manager`.`product_id` where warehouse_item_status = '0' ");
