                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" data-toggle="validator" id="form_add_new_branch" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Branch Manager Full Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" data-error="Enter Full Name" class="form-control" id="txt_branch_manager_full_name" placeholder="Branch Manager Full Name" required="required">
                                        </div>
                                        <div class="help-block with-errors" style="text-align: center"></div>
                                    </div>

                                     <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Branch Manager Username</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" data-error="Enter Branch Manager User Name" id="txt_branch_manager_user_name" placeholder="Enter Branch Manager User Name" required="required">
                                        </div>
                                        <div class="help-block with-errors" style="text-align: center"></div>
                                    </div>
                                    <div class="form-group">
