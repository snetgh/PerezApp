                                            ...
                                            <select class="form-control" id="select_user_type">
                                                <?php  $get_work_type_query = mysqli_query($connection,"SELECT * FROM `user_work_types`");
                                                    while ($work_type_items = mysqli_fetch_array($get_work_type_query)) { 
                                                        ...
                                                        if($work_type_items['work_type_id'] == '5' || $work_type_items['work_type_id'] == '6' || $work_type_items['work_type_id'] == '7'){
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <?php  $get_branch_query = mysqli_query($connection,"SELECT * FROM `system_branches` ");
                                                    while ($branch_items = mysqli_fetch_array($get_branch_query)) { 
                                                       $corrected_branch_letters = strtolower($branch_items['system_branch_name']);
                                                        if($branch_items['system_branch_name'] == $corrected_branch_letters){
