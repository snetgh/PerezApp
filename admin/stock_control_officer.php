                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="select_product_name">
                                                <?php  $get_product_name_query = mysqli_query($connection,"SELECT * FROM `product_names`");
                                                    while ($product_names = mysqli_fetch_array($get_product_name_query)) {  ?>

                                                <option value="<?php  echo $product_names['product_id']  ?>"><?php   echo $product_names['product_name']; ?></option>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="select_product_category">
                                                <?php  $get_product_category_query = mysqli_query($connection,"SELECT * FROM `product_category`");
