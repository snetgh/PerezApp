                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            <li title="Record New Arrivals"><a href="index.php?approve" class=" sf-handshake">Approve Products</a></li>
                            <li title="View Recorded Products"><a href="index.php?processed" class="sf-shield-ok">View Approved</a></li>
